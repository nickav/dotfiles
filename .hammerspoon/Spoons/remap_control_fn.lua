...
hs.hotkey.bind({'cmd'}, "F7", system("PREVIOUS"))
hs.hotkey.bind({'cmd'}, "F8", system("PLAY"))
hs.hotkey.bind({'cmd'}, "F9", system("NEXT"))
hs.hotkey.bind({'cmd'}, "F10", system("MUTE"))
hs.hotkey.bind({'cmd'}, "F11", system("SOUND_DOWN"), nil, system("SOUND_DOWN"))
hs.hotkey.bind({'cmd'}, "F12", system("SOUND_UP"), nil, system("SOUND_UP"))
